...
In the rest of our report, we intend to first group the genres into broader categories and then analyze the features throughout the genres. We want to discover which genres are the most popular and if the danceability of genres differs significantly. We will compare features to each other and test the correlations between two features to see if they have a strong linear relationship or not. In the end, we hope to discover how different genres are related to different features of music, as well and how different features relate to each other.
